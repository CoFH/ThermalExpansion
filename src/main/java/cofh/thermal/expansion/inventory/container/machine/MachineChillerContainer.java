...
import static cofh.thermal.expansion.init.TExpContainers.MACHINE_CHILLER_CONTAINER;

public class MachineChillerContainer extends TileCoFHContainer {

    public final Reconfigurable4WayBlockEntity tile;

    public MachineChillerContainer(int windowId, Level level, BlockPos pos, Inventory inventory, Player player) {
