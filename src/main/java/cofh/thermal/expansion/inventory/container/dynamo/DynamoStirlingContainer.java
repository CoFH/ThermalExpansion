...
import static cofh.thermal.expansion.init.TExpReferences.DYNAMO_STIRLING_CONTAINER;

public class DynamoStirlingContainer extends TileContainer {
    ...
    public DynamoStirlingContainer(int windowId, Level level, BlockPos pos, Inventory inventory, Player player) {
        ...
        super(DYNAMO_STIRLING_CONTAINER, windowId, level, pos, inventory, player);
