...
public class ChillerRecipeCategory extends ThermalRecipeCategory<RecipeHolder<ChillerRecipe>> {

    protected IDrawableStatic tankBackground;
    protected IDrawableStatic tankOverlay;

    public ChillerRecipeCategory(IGuiHelper guiHelper, ItemStack icon, RecipeType<RecipeHolder<ChillerRecipe>> type) {
    ...
    @Override
    public RecipeType<RecipeHolder<ChillerRecipe>> getRecipeType() {

        return type;
    }

    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, RecipeHolder<ChillerRecipe> recipe, IFocusGroup focuses) {
    ...
    @Override
    public void draw(RecipeHolder<ChillerRecipe> recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
