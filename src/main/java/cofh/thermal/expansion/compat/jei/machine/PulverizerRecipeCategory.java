...
public class PulverizerRecipeCategory extends ThermalRecipeCategory<RecipeHolder<PulverizerRecipe>> {

    public PulverizerRecipeCategory(IGuiHelper guiHelper, ItemStack icon, RecipeType<RecipeHolder<PulverizerRecipe>> type) {
    ...
    @Override
    public void setRecipe(IRecipeLayoutBuilder builder, RecipeHolder<PulverizerRecipe> recipe, IFocusGroup focuses) {
    ...
    public void draw(RecipeHolder<PulverizerRecipe> recipe, IRecipeSlotsView recipeSlotsView, GuiGraphics guiGraphics, double mouseX, double mouseY) {
        ...
        speedBackground.draw(guiGraphics, 34, 24);

        progress.draw(guiGraphics, 62, 24);
        speed.draw(guiGraphics, 34, 24);
    }
