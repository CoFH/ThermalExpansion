...
public class TExpBlocks {
    ...
    public static void register() {
        ...
        registerAugmentableBlock(ID_MACHINE_BREWER, () -> new TileBlockActive4Way(of(Material.METAL).sound(SoundType.NETHERITE_BLOCK).strength(2.0F).lightLevel(lightValue(ACTIVE, 3)), MachineBrewerTile.class, MACHINE_BREWER_TILE), machineAugs, MACHINE_VALIDATOR, getFlag(ID_MACHINE_BREWER), ID_THERMAL_EXPANSION);
        registerAugmentableBlock(ID_MACHINE_CRYSTALLIZER, () -> new TileBlockActive4Way(of(Material.METAL).sound(SoundType.NETHERITE_BLOCK).strength(2.0F).lightLevel(lightValue(ACTIVE, 7)), MachineCrystallizerTile.class, MACHINE_CRYSTALLIZER_TILE), machineAugs, MACHINE_VALIDATOR, getFlag(ID_MACHINE_CRYSTALLIZER), ID_THERMAL_EXPANSION);
