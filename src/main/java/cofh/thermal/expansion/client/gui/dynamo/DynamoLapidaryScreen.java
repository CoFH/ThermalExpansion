...
public class DynamoLapidaryScreen extends DynamoScreen<DynamoLapidaryMenu> {

    public static final String TEX_PATH = ID_THERMAL + ":textures/gui/container/item_dynamo.png";
    public static final ResourceLocation TEXTURE = new ResourceLocation(TEX_PATH);

    public DynamoLapidaryScreen(DynamoLapidaryMenu container, Inventory inv, Component titleIn) {
