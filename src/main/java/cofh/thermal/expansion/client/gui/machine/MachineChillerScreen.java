...
public class MachineChillerScreen extends MachineScreen<MachineChillerContainer> {

    public static final String TEX_PATH = ID_THERMAL + ":textures/gui/container/chiller.png";
    public static final ResourceLocation TEXTURE = new ResourceLocation(TEX_PATH);

    public MachineChillerScreen(MachineChillerContainer container, Inventory inv, Component titleIn) {
