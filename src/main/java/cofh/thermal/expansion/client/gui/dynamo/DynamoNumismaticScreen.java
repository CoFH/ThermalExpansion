...
public class DynamoNumismaticScreen extends DynamoScreen<DynamoNumismaticContainer> {

    public static final String TEX_PATH = ID_THERMAL + ":textures/gui/container/item_dynamo.png";
    public static final ResourceLocation TEXTURE = new ResourceLocation(TEX_PATH);

    public DynamoNumismaticScreen(DynamoNumismaticContainer container, Inventory inv, Component titleIn) {
