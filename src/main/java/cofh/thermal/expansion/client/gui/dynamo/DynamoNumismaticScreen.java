...
public class DynamoNumismaticScreen extends DynamoScreen<DynamoNumismaticMenu> {

    public static final String TEX_PATH = ID_THERMAL + ":textures/gui/container/item_dynamo.png";
    public static final ResourceLocation TEXTURE = new ResourceLocation(TEX_PATH);

    public DynamoNumismaticScreen(DynamoNumismaticMenu container, Inventory inv, Component titleIn) {
