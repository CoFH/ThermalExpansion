...
public class MachineSmelterScreen extends MachineScreenReconfigurable<MachineSmelterContainer> {
    ...
    public static final String TEX_PATH = ID_THERMAL + ":textures/gui/machines/smelter.png";
    public static final ResourceLocation TEXTURE = new ResourceLocation(TEX_PATH);

    public MachineSmelterScreen(MachineSmelterContainer container, PlayerInventory inv, ITextComponent titleIn) {
