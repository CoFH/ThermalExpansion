...
public class MachinePyrolyzerMenu extends BlockEntityCoFHMenu {

    public final Reconfigurable4WayBlockEntity tile;

    public MachinePyrolyzerMenu(int windowId, Level level, BlockPos pos, Inventory inventory, Player player) {
