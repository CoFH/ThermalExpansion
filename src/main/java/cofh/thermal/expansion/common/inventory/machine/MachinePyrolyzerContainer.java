...
import static cofh.thermal.expansion.init.registries.TExpContainers.MACHINE_PYROLYZER_CONTAINER;

public class MachinePyrolyzerContainer extends TileCoFHContainer {

    public final Reconfigurable4WayBlockEntity tile;

    public MachinePyrolyzerContainer(int windowId, Level level, BlockPos pos, Inventory inventory, Player player) {

        super(MACHINE_PYROLYZER_CONTAINER.get(), windowId, level, pos, inventory, player);
