...
public class DynamoLapidaryMenu extends BlockEntityCoFHMenu {

    public final DynamoBlockEntity tile;

    public DynamoLapidaryMenu(int windowId, Level level, BlockPos pos, Inventory inventory, Player player) {
